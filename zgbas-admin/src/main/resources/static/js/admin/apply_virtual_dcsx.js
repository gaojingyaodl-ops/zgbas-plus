var StockVirtual = {
    ...
    setPublicParam: function (virtual) {
        ...
        // 数量
        // ModuleUtil.numberboxReadOnly("#dealNumber", virtual.dealNumber);
    ...
    setBuyVirtual: function (virtual) {
        // 合同编号
        // $("#bcontentNo").val(virtual.stockVirtualNo);
        // $("#contentNo").val(StockVirtual.formatterVirtualContractNo(virtual.stockVirtualNo));
        // 采购来源
        ...
        // 采购需方
        var ConvertCompanyName = Convert.findValueByKey(_dcsxOurCompanyNameJson, "companyCd", virtual.ourCompanyName, "companyName");
        ModuleUtil.comboboxReadOnly("#buyOurCompanyName", ConvertCompanyName);
        $("#sellOurCompanyName").combobox("setValue", ConvertCompanyName);
        // 业务员
        ...
        // 付定金日期
        ModuleUtil.dateboxReadOnly("#buyPayBondTime", virtual.payBondTime);
        // 交货方式
        ...
        // 详细地址
        ModuleUtil.textboxReadOnly("#b_contactAddr", virtual.contactAddr);
        // 仓储费
        ModuleUtil.numberboxReadOnly("#bwarehouseCost", virtual.warehouseCost);
        // 运输费
        ModuleUtil.numberboxReadOnly("#btransportCost", virtual.transportCost);
        // 装卸费
        ModuleUtil.numberboxReadOnly("#bstevedorage", virtual.stevedorage);
        // 含税单价
    ...
    setSellVirtual: function (virtual) {
        ...
        // 销售需方
        var ConvertCompanyName = Convert.findValueByKey(_ourCompanyNameJson, "dictCd", virtual.ourCompanyName, "dictName");
        ModuleUtil.comboboxReadOnly("#ourCompanyName", ConvertCompanyName);
        // 业务员
        ...
        // 详细地址
        ModuleUtil.textboxReadOnly("#s_contactAddr", virtual.contactAddr);
        // 结算方式
    ...
    formatterVirtualContractNo(virtualContractNo){
        virtualContractNo = virtualContractNo.replaceAll("SPTB","SPTS")
        virtualContractNo = virtualContractNo.replaceAll("KCB","KCS")
        virtualContractNo = virtualContractNo.replaceAll("XYB","XYS")
...
var ModuleUtil = {
    ...
    textboxReadOnly: function (id, value){
