...
function lightenToColor(hex, percent) {
    hex = hex.replace(/^#/, '');
...
(function ($) {
    document.documentElement.style.setProperty('--skin-color', convertToSkin());
    document.documentElement.style.setProperty('--skin-tab-first-color', '#EAEEF2');
    document.documentElement.style.setProperty('--skin-select-color', lightenToColor(convertToSkin(), 40));
    document.documentElement.style.setProperty('--skin-over-color', lightenToColor(convertToSkin(), 60));
    $.extend({
        _tree: {},
        bttTable: {},
        // 表格封装处理
