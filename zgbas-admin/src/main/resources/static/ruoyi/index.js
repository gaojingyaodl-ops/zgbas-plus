    ...
    function closeTab() {
        ...
        if ($(this).parents('.menuTab').hasClass('active')) {
            ...
            if ($(this).parents('.menuTab').next('.menuTab').length) {
                ...
                $(this).parents('.menuTab').next('.menuTab:eq(0)').click();
                $('.mainContent .RuoYi_iframe').each(function() {
            ...
            if ($(this).parents('.menuTab').prev('.menuTab').length) {
                ...
                $(this).parents('.menuTab').prev('.menuTab:last').click();
                $('.mainContent .RuoYi_iframe').each(function() {
                    if ($(this).data('id') == activeId) {
                        $(this).show().siblings('.RuoYi_iframe').hide();
                        return false;
        ...
        // if (_approveProcessMenuViewFlag == false){
        //     //  移除当前选项卡
        //     $(this).parents('.menuTab').remove();
        //
        //     // 移除tab对应的内容区
    ...
    $.contextMenu({
        ...
        items: {
            ...
            "close_left": {
                ...
                callback: function(key, opt) {
                    setActiveTab(this);
                    this.prevAll('.menuTab').each(function() {
                        if(!$(this).hasClass('defaultShow')){
                            if ($(this).hasClass('active')) {
                                setActiveTab(this);
                            }
