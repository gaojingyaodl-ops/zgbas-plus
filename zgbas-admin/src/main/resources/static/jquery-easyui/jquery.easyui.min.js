...
var _b3=aa[_b2];
if(_b3=="list"){
var ps=$("<select class='pagination-page-list pageing-btn-select'></select>");
...
setTimeout(function() {
$("<td class='pl20'></td>").append("<span class='pageing-word'>每页 </span>").append(ps).appendTo(tr);
}, 100)
}else{
if(_b3=="sep"){
...
if(_b3=="manual"){
//setTimeout(function() {
//bb.num=$("<input class='pagination-page-list pageing-btn' type=\"text\" value=\"1\" size=\"2\">").appendTo(tr).wrap("<td class='pl20'>跳转至 </td>");
...
_b0.prepend("<div class=\"pagination-info\"></div>")
}else{
...
a.wrap("<td></td>");
switch(btn.iconCls) {
case 'pagination-first': btn.text = "首页"; break;
case 'pagination-prev': btn.text = "上一页"; break;
case 'pagination-next': btn.text = "下一页"; break;
case 'pagination-last': btn.text = "尾页"; break;
case 'pagination-refresh': btn.text = "刷新"; break;
}
a.addClass("pageing-btn btn-solid ml10")
a.linkbutton({plain:true,text:btn.text}).unbind(".pagination").bind("click.pagination",function(){
...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"总数 {total}",nav:{first:{iconCls:"pagination-first",handler:function(){
