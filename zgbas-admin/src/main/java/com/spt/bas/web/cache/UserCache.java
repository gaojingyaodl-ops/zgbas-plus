...
//	private static LoadingCache<Long, SysUserSdk> cache;
//
//	private UserCache() {
//		if (!isInited.get()) {
//			init();
...
//				.build(new CacheLoader<Long, SysUserSdk>() {
//					@Override
//					public SysUserSdk load(Long userId) throws Exception {
...
//						SysUserSdk entity = service.findUserById(userId);
//						return entity;
//
//					}
//				});
...
//	}
//
//	public static SysUserSdk getEntity(Long userId) {
...
//		SysUserSdk entity = getEntity(id);
//		if (entity != null) {
