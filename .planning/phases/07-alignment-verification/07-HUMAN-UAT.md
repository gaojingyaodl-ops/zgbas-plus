...
result: PASS (2026-07-20) — 全链路端点可达 + quartz 触发成功
...
result: PASS (2026-07-20) — autoPay + refreshContractStatusTask 真跑成功
