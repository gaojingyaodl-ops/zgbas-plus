 ...
 *
 * @Author: gaojy
 * @create 2022/5/9 10:19
 * @version: 1.0
 * @description:
 */
@Entity
@Table(name = "t_stock_virtual")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class StockVirtual extends IdEntity implements IPmEntity {
    private static final long serialVersionUID = -1468332066029662846L;
     ...
     * 申请单ID
     */
    private Long bizApplyVirtualId;
     ...
     * 撮合明细id
     */
    private Long applyMatchDetailId;
    ...
    /**
     * 状态（N-新录入、I-申请中、A-已审批、S-已签约、C-已失效、F-待释放、Y-已释放）
     */
    ...
    public Long getBizApplyVirtualId() {
        return bizApplyVirtualId;
    }

    public void setBizApplyVirtualId(Long bizApplyVirtualId) {
        this.bizApplyVirtualId = bizApplyVirtualId;
    }
    ...
    public String getVirtualBuyType() {
        return virtualBuyType;
    }

    public void setVirtualBuyType(String virtualBuyType) {
        this.virtualBuyType = virtualBuyType;
    }
    ...
    public Long getApplyMatchDetailId() {
        return applyMatchDetailId;
    }

    public void setApplyMatchDetailId(Long applyMatchDetailId) {
        this.applyMatchDetailId = applyMatchDetailId;
    }
    ...
    public String getLinkApproveNo() {
        return linkApproveNo;
    }

    public void setLinkApproveNo(String linkApproveNo) {
        this.linkApproveNo = linkApproveNo;
    }
