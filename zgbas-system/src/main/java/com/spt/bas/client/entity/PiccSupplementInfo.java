 ...
 */
@Entity
@Table(name = "t_picc_supplement_info")
public class PiccSupplementInfo extends IdEntity {
    ...
    public Date getApplyPiccDate() {
        return applyPiccDate;
    }

    public void setApplyPiccDate(Date applyPiccDate) {
        this.applyPiccDate = applyPiccDate;
    }
}
