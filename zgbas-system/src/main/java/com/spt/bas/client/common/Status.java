...
public enum Status {
     ...
     * 该企业还未绑定
     */
    COMPANY_NOT_BIND(5036, "该企业还未绑定"),

    /**
     * 企业信息不存在
     */
    NO_REG_COMPANY(5037, "企业信息不存在"),

    /**
     * 公司已存在
     */
    COMPANY_EXIST(5037, "公司已存在"),
    /**
     * 服务不存在
     */
    NO_SERVICE(5038, "服务不存在"),
    /**
     * 法人信息不一致
     */
    LEGALREPRESENT_DIFF(5039, "法人信息不一致"),

    /**
     * 该联系人手机号已绑定过其他企业，无法再次绑定
     */
    CONTACT_PHONE_HAS_BIND(5040, "该联系人手机号已绑定过其他企业，无法再次绑定"),

    /**
     * 该联系人手机号在其他公司已使用
     */
    CONTACT_PHONE_IN_USE(5041, "该联系人手机号在其他公司已使用"),

    /**
     * xml解析错误
     */
    XML_PARSE_FAIL(5042, "xml解析错误"),

    /**
     * 参数校验不通过
     */
    PARAM_VALID_FAIL(5043, "参数校验不通过"),

    FOLLOW_LIMIT(5044, "当天领用客户已达上限"),

    COMPANY_ALREADY_FOLLOW(5045, "该客户已被领用"),
     ...
     *预算不存在
     */
    BUDGET_NO_EXIST(5016, "预算不存在"),

    /**
     * 未满天数
     */
    NOT_REACH(5046, "弃用后,天数未满不可领用"),
    ;
