 ...
 */
@Entity
@Table(name = "t_apply_inventory_virtual")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class ApplyInventoryVirtual extends IdEntity implements IPmEntity {
    private static final long serialVersionUID = 8545540541699363877L;
