...
@Entity
@Table(name = "t_ctr_contract_apply")
public class CtrContractApply extends IdEntity {
	 ...
	 * 申请中服务费开票金额
	 */
	private BigDecimal applyServiceBillAmount = BigDecimal.ZERO;
	 ...
	 * 运输费
	 */
	private BigDecimal applyTransportAmount = BigDecimal.ZERO;

	/**
	 * 仓储费
	 */
	private BigDecimal applyWarehouseAmount = BigDecimal.ZERO;

	/**
	 * 装卸费
	 */
	private   BigDecimal applyStevedorage = BigDecimal.ZERO;
	...
	public BigDecimal getApplyServiceBillAmount() {
		return applyServiceBillAmount;
	}

	public void setApplyServiceBillAmount(BigDecimal applyServiceBillAmount) {
		this.applyServiceBillAmount = applyServiceBillAmount;
	}

	public BigDecimal getApplyTransportAmount() {
		return Objects.isNull(applyTransportAmount) ? BigDecimal.ZERO : applyTransportAmount;
	}

	public void setApplyTransportAmount(BigDecimal applyTransportAmount) {
		this.applyTransportAmount = applyTransportAmount;
	}

	public BigDecimal getApplyWarehouseAmount() {
		return Objects.isNull(applyWarehouseAmount) ? BigDecimal.ZERO : applyWarehouseAmount;
	}

	public void setApplyWarehouseAmount(BigDecimal applyWarehouseAmount) {
		this.applyWarehouseAmount = applyWarehouseAmount;
	}

	public BigDecimal getApplyStevedorage() {
		return Objects.isNull(applyStevedorage) ? BigDecimal.ZERO : applyStevedorage;
	}

	public void setApplyStevedorage(BigDecimal applyStevedorage) {
		this.applyStevedorage = applyStevedorage;
	}
}
