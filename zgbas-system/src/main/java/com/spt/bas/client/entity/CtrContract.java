 ...
 */
@Entity
@Table(name = "t_ctr_contract")
@DynamicInsert
@DynamicUpdate
public class CtrContract extends IdEntity implements IPmEntity {
    ...
    /**
     * 人保申报状态：0-未申报，1-已申报，2-申报成功，3-申报退回，4-已还款
     */
    private String piccDeclareStatus;
     ...
     * 协议单价
     */
    private BigDecimal agreementDealPrice;
     ...
     * 是否代采赊销预算
     */
    private Boolean dcsxFlg = false;

    /**
     * 企业是否人保授信
     */
    private Boolean companyPiccFlg;
     ...
     * 预算装卸费
     */
    private BigDecimal  approveStevedorage;
     ...
     * 出库审批中占用货款
     */
    private BigDecimal approveDeliveryAmount;
    ...
    public BigDecimal getApproveDeliveryAmount() {
        return defaultNum(approveDeliveryAmount);
    }

    public void setApproveDeliveryAmount(BigDecimal approveDeliveryAmount) {
        this.approveDeliveryAmount = approveDeliveryAmount;
    }
     ...
     * 金融服务费率
     */
    private BigDecimal financialServiceRate = BigDecimal.ZERO;

    /**
     * 特殊链条合同标识
     */
    private Boolean specialChainFlag = false;
    ...
    public Boolean getCompanyPiccFlg() {
        return companyPiccFlg;
    }

    public void setCompanyPiccFlg(Boolean companyPiccFlg) {
        this.companyPiccFlg = companyPiccFlg;
    }
    ...
    public boolean equals(Object obj) {
        ...
        CtrContract other = (CtrContract) obj;
        if (id == null) {
            if (other.id != null)
                return false;
    ...
    public Boolean getSealFlg() {
        return Objects.nonNull(sealFlg) && sealFlg;
    }
    ...
    public BigDecimal getFinancialServiceRate() {
        return financialServiceRate;
    }

    public void setFinancialServiceRate(BigDecimal financialServiceRate) {
        this.financialServiceRate = financialServiceRate;
    }

    public BigDecimal getApproveStevedorage() {
        return approveStevedorage;
    }

    public void setApproveStevedorage(BigDecimal approveStevedorage) {
        this.approveStevedorage = approveStevedorage;
    }
    ...
    public BigDecimal getAgreementDealPrice() {
        return agreementDealPrice;
    }

    public void setAgreementDealPrice(BigDecimal agreementDealPrice) {
        this.agreementDealPrice = agreementDealPrice;
    }
    ...
    public BigDecimal getDiscountChargeAmount() {
        return defaultNum(discountChargeAmount);
    }
    ...
    public BigDecimal getDiscountReceiveAmount() {
        return defaultNum(discountReceiveAmount);
    }
    ...
    public Boolean getInsuranceFlag() {
        return !Objects.isNull(insuranceFlag) && insuranceFlag;
    }
    ...
    public String getPiccDeclareStatus() {
        return piccDeclareStatus;
    }

    public void setPiccDeclareStatus(String piccDeclareStatus) {
        this.piccDeclareStatus = piccDeclareStatus;
    }

    public Date getPiccSendDate() {
        return piccSendDate;
    }

    public void setPiccSendDate(Date piccSendDate) {
        this.piccSendDate = piccSendDate;
    }

    public Date getPiccReceiveDate() {
        return piccReceiveDate;
    }

    public void setPiccReceiveDate(Date piccReceiveDate) {
        this.piccReceiveDate = piccReceiveDate;
    }
    ...
    public Boolean getSpecialChainFlag() {
        return specialChainFlag;
    }

    public void setSpecialChainFlag(Boolean specialChainFlag) {
        this.specialChainFlag = specialChainFlag;
    }
