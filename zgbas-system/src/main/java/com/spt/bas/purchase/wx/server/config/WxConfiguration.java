...
@Configuration
@EnableConfigurationProperties(WxMiniAppConfig.class)
public class WxConfiguration {

    private static WxMiniAppConfig properties;

    private static Map<String, WxMaMessageRouter> routers = Maps.newHashMap();
    private static Map<String, WxMaService> maServices = Maps.newHashMap();

    @Autowired
    public WxConfiguration(WxMiniAppConfig properties) {
        WxConfiguration.properties = properties;
    }
    ...
    @PostConstruct
    public void init() {
        List<WxMiniAppConfig.Config> configs = properties.getConfigs();
        if (configs == null) {
            throw new BaseException(Status.ERROR, "小程序配置错误");
        }
