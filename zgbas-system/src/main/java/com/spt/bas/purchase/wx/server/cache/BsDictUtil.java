...
import com.spt.bas.purchase.wx.server.service.IBsDictService;
...
//						JsonUtil.obj2Json()
	...
	public static String getValue(String category, String key) {
		return getValue(BasConstants.ZG_ENTERPRISE_ID, category, key);
	}
	...
	public static String getValueEn(String category, String key) {
		return getValueEn(BasConstants.ZG_ENTERPRISE_ID, category, key);
	}
