...
import com.spt.bas.server.service.IApplyDcsxPayService;
...
public class ApplyDcsxPayApi extends BaseApi<ApplyPay> {
    @Autowired
    private IApplyPayService applyPayService;

    @Autowired
    private IApplyDcsxPayService applyDcsxPayService;
    ...
    List<ApplyPay> findApplyPay(@RequestBody String contractNo){
        return applyDcsxPayService.findApplyPay(contractNo);
    };
