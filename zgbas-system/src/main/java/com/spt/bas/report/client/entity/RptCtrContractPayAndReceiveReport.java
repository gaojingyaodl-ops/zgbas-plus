...
public class RptCtrContractPayAndReceiveReport {

	private Long id;// 合同详情ID
	...
	private BigDecimal bondAmount;//预付定金：采购：付款金额，销售：收款金额
	...
	private BigDecimal shouldAmount = BigDecimal.ZERO; 		//应收付金额
	...
	private String businessType;//销售业务类型
	private String receiveAmount; //收款金额（审批同意后每次操作的收款金额）
	@DateTimeFormat(pattern = "yyyy-MM-dd")
	@JsonFormat(pattern = "yyyy-MM-dd", timezone = "GMT+08:00")
	private Date receiveDate; // 收款日期
	@DateTimeFormat(pattern = "yyyy-MM-dd")
	@JsonFormat(pattern = "yyyy-MM-dd", timezone = "GMT+08:00")
	private Date realWarehoseDate;//实际出库（发货）时间
	private BigDecimal confirmReceiveNumber;//确认收货数量
	...
	private String piccPushFlg;//picc人保推送状态1为成功
	private String piccMessage; //picc人保回传信息
	//合计
	private BigDecimal sumTotalNumber;//统计合同数量
	private BigDecimal sumTotalAmount;//统计合同总价
	private BigDecimal sumWarehouseNumber;//统计发货数量
	private BigDecimal sumConfirmReceiveNumber;//统计收货确认数量
	private BigDecimal sumReceiveAmount;//统计收款金额
	private BigDecimal sumShouldAmount;		//统计应收付款金额
	private BigDecimal sumDealedAmount; 	//统计已收付款金额
	
	private String shouldPayType;	//应付款类型
	@DateTimeFormat(pattern = "yyyy-MM-dd")
	@JsonFormat(pattern = "yyyy-MM-dd", timezone = "GMT+08:00")
	private Date shouldPayDate;	//应付款日期
	...
	public BigDecimal getSumTotalNumber() {
		return sumTotalNumber;
	}
	public void setSumTotalNumber(BigDecimal sumTotalNumber) {
		this.sumTotalNumber = sumTotalNumber;
	}
	...
	public BigDecimal getSumWarehouseNumber() {
		return sumWarehouseNumber;
	}
	public void setSumWarehouseNumber(BigDecimal sumWarehouseNumber) {
		this.sumWarehouseNumber = sumWarehouseNumber;
	}
	public BigDecimal getSumConfirmReceiveNumber() {
		return sumConfirmReceiveNumber;
	}
	public void setSumConfirmReceiveNumber(BigDecimal sumConfirmReceiveNumber) {
		this.sumConfirmReceiveNumber = sumConfirmReceiveNumber;
	}
	...
	public BigDecimal getSumDealedAmount() {
		return sumDealedAmount;
	}
	public void setSumDealedAmount(BigDecimal sumDealedAmount) {
		this.sumDealedAmount = sumDealedAmount;
	}
