 ...
 * 出库表单
 */
public class RptApplyDeliveryReport {
	...
	private String buyContractNo;	//销售对应采购合同号
	private String realBuyContractNo;//出库货物对应采购合同编号
	...
	private String operation;		//状态 0有效  2作废
