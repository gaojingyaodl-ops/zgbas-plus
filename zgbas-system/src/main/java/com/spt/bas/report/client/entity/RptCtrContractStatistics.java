 ...
 * @author zhouzihang
 */
public class RptCtrContractStatistics {
	...
	private BigDecimal dealNumberTotal = BigDecimal.ZERO;// 采购总量
	private BigDecimal salesNumberTotal = BigDecimal.ZERO;// 销售总量
	private BigDecimal remainNumberTotal = BigDecimal.ZERO;// 剩余总量
	private BigDecimal overplusPriceTotal = BigDecimal.ZERO;// 剩余总值
	private BigDecimal occupation = BigDecimal.ZERO;//资金占用
	public Long getId() {
		return id;
	}
	...
	public BigDecimal getDealNumberTotal() {
		return dealNumberTotal;
	}
	public void setDealNumberTotal(BigDecimal dealNumberTotal) {
		this.dealNumberTotal = dealNumberTotal;
	}
	public BigDecimal getSalesNumberTotal() {
		return salesNumberTotal;
	}
	public void setSalesNumberTotal(BigDecimal salesNumberTotal) {
		this.salesNumberTotal = salesNumberTotal;
	}
	public BigDecimal getRemainNumberTotal() {
		return remainNumberTotal;
	}
	public void setRemainNumberTotal(BigDecimal remainNumberTotal) {
		this.remainNumberTotal = remainNumberTotal;
	}
	public BigDecimal getOverplusPriceTotal() {
		return overplusPriceTotal;
	}
	public void setOverplusPriceTotal(BigDecimal overplusPriceTotal) {
		this.overplusPriceTotal = overplusPriceTotal;
	}
