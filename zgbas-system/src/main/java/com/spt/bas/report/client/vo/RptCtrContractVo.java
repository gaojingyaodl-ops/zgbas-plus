 ...
 *
 * @Author: shengong
 * @Date: Created in 2020-11-09 09:17
 */
public class RptCtrContractVo {
    /**
     * 1:白条（一票制）
     * 2:白条（两票制）
     * 3:白条
     ...
     * 品名列表
     */
    private List<RptCtrProductVo> products;
     ...
     * 是否需要签署保理
     */
    private Boolean needDebtCertificateFlg = false;
     ...
     * 债权凭证附件URL
     */
    private String debtCertificateFileUrl;
     ...
     * 全部收货按钮
     */
    private Integer receiptButtonFlag;

    public Integer getReceiptButtonFlag() {
        return receiptButtonFlag;
    }

    public void setReceiptButtonFlag(Integer receiptButtonFlag) {
        this.receiptButtonFlag = receiptButtonFlag;
    }
    ...
    public List<RptCtrProductVo> getProducts() {
        return products;
    }

    public void setProducts(List<RptCtrProductVo> products) {
    ...
    public Boolean getNeedDebtCertificateFlg() {
        return needDebtCertificateFlg;
    }

    public void setNeedDebtCertificateFlg(Boolean needDebtCertificateFlg) {
        this.needDebtCertificateFlg = needDebtCertificateFlg;
    }

    public String getDebtCertificateFileUrl() {
        return debtCertificateFileUrl;
    }

    public void setDebtCertificateFileUrl(String debtCertificateFileUrl) {
        this.debtCertificateFileUrl = debtCertificateFileUrl;
    }
