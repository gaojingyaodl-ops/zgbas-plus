 ...
 * 调度日志操作处理
 *
 * <p>Phase 6 (QUARTZ-01 + D-P6-10) — ported from
 * {@code spt-auth/auth-quartz/.../controller/SysJobLogController.java}. Pitfall 4
 * adaptation: {@code @PreAuthorize} annotations replaced by Shiro
 * {@link RequiresPermissions} (W5 compensation, ASVS V4.1.1).
 *
 * @author ruoyi
 */
@RestController
