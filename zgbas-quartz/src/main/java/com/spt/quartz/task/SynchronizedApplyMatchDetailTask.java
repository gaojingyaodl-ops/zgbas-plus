 ...
 * 同步老审批和数据中台合同表数据定时任务
 *
 * <p>Phase 6 (06-03) — ported from {@code com.spt.bas.server.rocketmq.task.SynchronizedApplyMatchDetailTask}.
 * Bean name {@code "synchronizedApplyMatchDetailTask"} aligns with {@code sys_job.invoke_target}
 * short name {@code synchronizedApplyMatchDetailTask.synchronizedAllApplyMatchDetail}. Per D-P6-11,
 ...
 */
@Component("synchronizedApplyMatchDetailTask")
public class SynchronizedApplyMatchDetailTask {
