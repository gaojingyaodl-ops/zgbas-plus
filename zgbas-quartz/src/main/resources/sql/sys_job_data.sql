...
INSERT INTO sys_job VALUES (137, '根据合同编号更新计算违约金',                  'DEFAULT', 'budgetSettlementTask.updateBudgetSettlementByContractNo(\'\')',      '0 0 0 1 1 ? 2099','3','1', '1', 'admin', sysdate(), '', null, '迁自 xxl-job updateBudgetSettlementByContractNo (源 NONE + trigger_status=0; REVIEW: method wants String param, empty arg passed)');
...
-- xxl_job_info.id=41 (stopped, CRON '* * 1 ? * 7' — REVIEW: every-second frequency at 1am Sat, but PAUSED so never fires)
INSERT INTO sys_job VALUES (141, '全量同步t_bs_company',                        'DEFAULT', 'synchronizedBsCompanyTask.synchronizedAllBsCompany',                 '* * 1 ? * 7',    '3', '1', '1', 'admin', sysdate(), '', null, '迁自 xxl-job synchronizedAllBsCompany (源 trigger_status=0; REVIEW: cron extreme frequency, but PAUSED)');

-- xxl_job_info.id=42 (running, CRON 0 0 3 * * ?, param empty — REVIEW: method refreshProfitData(String) wants approveNo)
INSERT INTO sys_job VALUES (142, '刷新风控利润统计数据',                        'DEFAULT', 'ctrContractProfitTask.refreshProfitData(\'\')',                      '0 0 3 * * ?',    '3', '1', '0', 'admin', sysdate(), '', null, '迁自 xxl-job refreshProfitData (REVIEW: source executor_param empty; method wants String approveNo, empty arg passed)');
...
-- xxl_job_info.id=44 (running, CRON '0 0 1 ? * 1' — REVIEW: quartz dow=1=Sunday; xxl-job same CronExpression semantics)
INSERT INTO sys_job VALUES (144, 'zgbase全量同步数据中台work_target',           'DEFAULT', 'synchronizedWorkTargetTask.synchronizedAllWorkTarget',               '0 0 1 ? * 1',    '3', '1', '0', 'admin', sysdate(), '', null, '迁自 xxl-job synchronizedAllWorkTarget (REVIEW: dow=1=Sunday in quartz)');
...
INSERT INTO sys_job VALUES (146, 'zgbas全量同步数据中台t_bs_company',           'DEFAULT', 'synchronizedBsCompanyTask.synchronizedAllBsCompany',                 '0 0 1 ? * 1',    '3', '1', '0', 'admin', sysdate(), '', null, '迁自 xxl-job synchronizedAllBsCompany (与 id=41 同 handler, 不同 cron/name; REVIEW dow=1=Sunday)');
...
INSERT INTO sys_job VALUES (155, '补偿结算单收违约金提成',                      'DEFAULT', 'settlementTask.refreshBreachCommission(\'\')',                       '0 0 0 1 1 ? 2099','3','1', '1', 'admin', sysdate(), '', null, '迁自 xxl-job refreshBreachCommission (源 NONE + trigger_status=0; REVIEW: method wants String contractNo, empty arg passed)');
...
INSERT INTO sys_job VALUES (159, '初始化物流单据',                              'DEFAULT', 'ctrContractScheduleTask.initLogistics(\'\')',                        '0 0 0 1 1 ? 2099','3','1', '1', 'admin', sysdate(), '', null, '迁自 xxl-job initLogistics (源 NONE + trigger_status=0; REVIEW: method wants String contractNo, empty arg passed)');
...
INSERT INTO sys_job VALUES (163, '代采赊销盖章申请，附件生成异常补偿任务',      'DEFAULT', 'autoSealPdfTask.generateSealPDFSignDCSX(\'approveNo,contractNo\')',  '0 0 0 1 1 ? 2099','3','1', '1', 'admin', sysdate(), '', null, '迁自 xxl-job generateSealPDFSignDCSX (源 NONE + trigger_status=0; REVIEW: executor_param looks like placeholder name list, kept literal)');

-- xxl_job_info.id=64 (stopped, NONE — method wants String param, empty arg)
INSERT INTO sys_job VALUES (164, '代采赊销盖章审批完成后自动执行签署逻辑补偿任务', 'DEFAULT', 'autoSealPdfTask.successSignContractByKeyword(\'\')',                '0 0 0 1 1 ? 2099','3','1', '1', 'admin', sysdate(), '', null, '迁自 xxl-job successSignContractByKeyword (源 NONE + trigger_status=0; REVIEW: method wants String param, empty arg passed)');

-- xxl_job_info.id=65 (running, CRON 0 0 23 ? * *, method wants String contractNo, empty arg)
INSERT INTO sys_job VALUES (165, '更新中游逾期利息',                            'DEFAULT', 'ctrContractScheduleTask.refreshOverdueInterest(\'\')',                '0 0 23 ? * *',   '3', '1', '0', 'admin', sysdate(), '', null, '迁自 xxl-job refreshOverdueInterest (REVIEW: source executor_param empty; method wants String contractNo, empty arg passed)');
...
INSERT INTO sys_job VALUES (186, '业务盖章异常生成补偿任务',                    'DEFAULT', 'ctrContractScheduleTask.autoInitiatedSealUsage(\'\')',               '0 0 0 1 1 ? 2099','3','1', '1', 'admin', sysdate(), '', null, '迁自 xxl-job autoInitiatedSealUsage (源 NONE + trigger_status=0; REVIEW: method wants String approveNo, empty arg passed)');
...
INSERT INTO sys_job VALUES (189, '刷新发货文件',                                'DEFAULT', 'ctrContractScheduleTask.refreshShippingFile(\'contractNo\')',        '0 0 1 * * ?',    '3', '1', '1', 'admin', sysdate(), '', null, '迁自 xxl-job refreshShippingFile (源 trigger_status=0; REVIEW: executor_param \'contractNo\' looks like placeholder name, kept literal)');
