...
public final class HTTPUtility {
	...
	private final static Logger log = LoggerFactory.getLogger(HTTPUtility.class);
	 ...
	 * @return
	 */
	public static String doPost(String url, Map<String, String> paramsMap, Boolean isXml) throws Exception {
	...
	private static String doPost(String url, Map<String, String> paramsMap, String jsonXMLString, Boolean isXml)
			throws Exception {
		return doPost(url, paramsMap, null, jsonXMLString, isXml,true);
	}
	public static String doPost(String url, Map<String, String> paramsMap,Map<String, String> headerMap)
			throws Exception {
		return doPost(url, paramsMap, headerMap, null, false,false);
	}

	public static String doPost(String url, Map<String, String> paramsMap, Map<String, String> headerMap,
			boolean showLog) throws Exception {
		return doPost(url, paramsMap, headerMap, null, false, showLog);
	}
	private static String doPost(String url, Map<String, String> paramsMap,Map<String, String> headerMap, String jsonXMLString, Boolean isXml,boolean showLog)
			throws Exception {
	...
	public static String doPostBody(String url, Object param, Map<String, String> headerMap,boolean showLog)
			throws Exception {
	...
	public static String doPostJson(String url, String jsonStr, Map<String, String> headerMap,boolean showLog)
			throws Exception {
